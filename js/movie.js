...
function getMovies(keyword) {
  return fetch('https://cors-anywhere.herokuapp.com/https://www.omdbapi.com/?apikey=f7a4022a&s=' + keyword)
  .finally(() => {
    const movieLoader = document.querySelector('.movie-loader');
    movieLoader.classList.toggle('loader');
  })
...
function getMoviesDetails(imdbId) {
  return fetch('https://cors-anywhere.herokuapp.com/https://www.omdbapi.com/?apikey=f7a4022a&i=' + imdbId)
  .finally(() => {
    const movieLoader = document.querySelector('.modal-detail-loader');
    movieLoader.classList.toggle('loader');
  })
